/*
   ...
   Subversion Revision: $Revision: 153 $
   ...
   Last update: $Date: 2015-06-28 22:05:57 -0700 (Sun, 28 Jun 2015) $
...
/********************************************************************/
var titleString       = "Adobe InDesign Calendar Wizard: Version 3.18.00";
                 ...
                 if( bPrintHoliday )
                 {
                    if( !bItemIn( holidaysBuffer[1], printedHolidays ) )
                    {
                       ...
                       if( settings.bHighlightHolidays == true)
                       {
                          if( settings.bCellStyles == true )
                          {
                             myCalendarCells[i].appliedCellStyle = myDocument.cellStyles.item("cal_holidayDate" + settings.styleSet);
                          }
                          else
                          {
     ...
     /* if( settings.bBackgroundLayer ) //changed, dont make this color
      ...
      try{ paragraphStyles.item("cal_date" + settings.styleSet).name; }
         ...
         paragraphStyles.add({name:"cal_date" + settings.styleSet, basedOn:paragraphStyles.item("cal_base" + settings.styleSet),
            justification:Justification.rightAlign, appliedFont:"Arial" , fontStyle:"Bold",
          ...
          with(dialogColumns.add())
          {
            ...
            with(dialogRows.add())
            {
               ...
               with(dialogColumns.add())
               {
                 ...
                 selector.AddBackgroundLayer = checkboxControls.add({checkedState:true});//changed
               }
            }
            with(dialogColumns.add())
            {
